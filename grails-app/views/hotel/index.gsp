        ...
        <div class="card-body">
            ...
            <g:each in="${hotelList}" var="hotel">
                ...
                <div class="container border p-2 d-flex m-1 row">
                    <div class="col-3"><g:link controller="hotel" action="show"
                                               id="${hotel.id}">${hotel.name}</g:link></div>

                    <div class="col-2"><g:link controller="country" action="show"
                                               id="${hotel.country.id}">${hotel.country.name}</g:link></div>
